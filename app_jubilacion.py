...
# ============================================================
# FUNÇÃO DE ESTILIZAÇÃO (compatível com pandas novo e antigo)
# ============================================================
...
if not df_principal.empty:
    ...
    # Aplicar cores (compatível com qualquer versão do pandas)
...
if not df_eric.empty:
    ...
    # Aplicar cores (compatível com qualquer versão)
